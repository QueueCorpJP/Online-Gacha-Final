    ...
    ja: {
        ...
        terms: {
            ...
            sections: {
                introduction: {
                    title: "1. はじめに",
                    content: "この利用規約（以下、「本規約」といいます。）は、ガチャゲーム（以下、「当社」といいます。）がウェブサイトにて提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。"
                },
                registration: {
                    title: "2. 利用登録",
                    content: "本サービスの利用を希望する方は、本規約に同意の上、当社の定める方法によって利用登録を申請し、当社がこれを承認することによって、本サービスの利用登録をすることができます。"
                },
                accountManagement: {
                    title: "3. ユーザーIDおよびパスワードの管理",
                    content: "ユーザーは、自己の責任において、本サービスのユーザーIDおよびパスワードを適切に管理するものとします。ユーザーは、いかなる場合も、ユーザーIDおよびパスワードを第三者に譲渡または貸与、もしくは第三者と共有することはできません。当社は、ユーザーIDとパスワードの組み合わせが登録情報と一致してログインされた場合には、そのユーザーIDを登録しているユーザー自身による利用とみなします。"
                },
                prohibitedMatters: {
                    title: "4. 禁止事項",
      ...
      当社は、本サービスに起因してユーザーに生じたあらゆる損害について、当社の故意又は重過失による場合を除き、一切の責任を負いません。ただし、本サービスに関する当社とユーザーとの間の契約（本規約を含みます。）が消費者契約法に定める消費者契約となる場合、この免責規定は適用されません。`
        ...
        privacy: {
            ...
            sections: {
                introduction: {
                    title: "1. はじめに",
                    content: "ガチャゲーム（以下、「当社」といいます。）は、本ウェブサイトで提供するサービス（以下、「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。"
                },
                collection: {
                    title: "2. 個人情報の収集方法",
                    content: "当社は、ユーザーが利用登録をする際に、氏名、生年月日、住所、電話番号、メールアドレス、銀行口座番号、クレジットカード番号などの個人情報をお尋ねすることがあります。また、ユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録や決済に関する情報を、当社の提携先（情報提供元、広告主、広告配信先などを含みます。以下、｢提携先｣といいます。）などから収集することがあります。"
                },
                purpose: {
      ...
      ・ユーザーに利用規約に違反する行為がある場合、またはそのおそれのある場合に確認や警告を行うため
      ...
      ・国の機関もしくは地方公共団体またはその委託を受けた者が法令の定める事務を遂行することに対して協力する必要がある場合であって、本人の同意を得ることにより当該事務の遂行に支障を及ぼすおそれがあるとき`
                ...
                disclosure: {
                    title: "5. 個人情報の開示",
                    content: `当社は、本人から個人情報の開示を求められたときは、本人に対し、遅滞なくこれを開示します。ただし、開示することにより次のいずれかに該当する場合は、その全部または一部を開示しないことがあり、開示しない決定をした場合には、その旨を遅滞なく通知します。
      ...
      住所：〒XXX-XXXX 東京都○○区○○1-2-3
      社名：株式会社ガチャゲーム
      担当部署：カスタマーサポート
      Eメールアドレス：privacy@gachagame.com`
                }
            },
            footer: {
                conclusion: "以上"
        ...
        gachaForm: {
            ...
            commonSettings: {
                ...
                pityThreshold: {
                    ...
                    help: "Guarantees a rarity A item after this many pulls"
                },
                type: {
                    label: "Gacha Type",
